...
async function main() {
    ...
    const admin = await prisma.user.upsert({
        ...
        update: {},
        create: { email: 'admin@amalner.gov.in', name: 'Amalner Admin', passwordHash: hash, role: client_1.Role.SUPER_ADMIN },
    });
    const citizen = await prisma.user.upsert({
        where: { email: 'citizen@example.com' },
        update: {},
        create: { email: 'citizen@example.com', name: 'Rahul Deshmukh', passwordHash: hash, role: client_1.Role.CITIZEN, phone: '9876543210' },
    });
    const worker = await prisma.user.upsert({
        where: { email: 'worker@amalner.gov.in' },
        update: {},
        create: {
            email: 'worker@amalner.gov.in', name: 'Suresh Patil', passwordHash: hash, role: client_1.Role.WORKER,
        ...
        data: [
            {
                ...
                wardId: ward1.id,
                aiCategory: 'Pothole',
                aiPriority: client_1.Priority.HIGH,
                aiConfidence: 0.96,
            ...
            },
            {
                ...
                wardId: ward2.id,
                aiCategory: 'Garbage',
                aiPriority: client_1.Priority.MEDIUM,
                aiConfidence: 0.89,
            ...
            },
            {
                ...
                aiPriority: client_1.Priority.LOW,
                aiConfidence: 0.92,
